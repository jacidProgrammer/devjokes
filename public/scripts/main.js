...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    document.getElementById("next-joke-btn").addEventListener("click", async () => {
        try {
            // Fetch the next joke from the server
            ...
            // Update the joke content on the page
            document.getElementById("joke-setup").textContent = data[0].setup;
            document.getElementById("joke-punchline").textContent = data[0].punchline;
        } catch (error) {
